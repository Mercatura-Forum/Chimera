...
module {
  ...
  /// The custody job, after both: the corporate actions due, their entitlements and payments.
  ...
  public func planInput(book : Text, shardSize : Nat) : Batch.Input {
    { scopes = [{ scope = book; qualifier = ""; entities = 0; jobs = [JOB_TREASURY, JOB_CALLS, JOB_CUSTODY] }]; shardSize }
  };
