...
check(summary.moneyMoving == 15, "fifteen money-moving rows: amend, cancel, settle, mark, resolve, revalue, the call rate, balance and settlement, the depot transfer, the corporate action processed, the settlement instructed, bought in, cancelled and split");
