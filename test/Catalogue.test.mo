...
check(summary.moneyMoving == 22, "twenty-two money-moving rows: the hedge assessed and dedesignated, amend, cancel, settle, mark, resolve, revalue, the call rate, balance and settlement, the depot transfer, the corporate action processed, the settlement instructed, bought in, cancelled and split, the repo settled, re-priced and margined, the loan settled, the financing instructed");
